...
for (var i = 0; i < incompleteTasksHolder.children.lenght; i++) {
    //bind eventts to list item's children (taskCompleted)
    bindTaskEvents(incompleteTasksHolder.children[i], taskCompleted);
}


//cycle over the completeTasksHolder ul list items
for (var i = 0; i < completeTasksHolder.children.lenght; i++) {
    //bind eventts to list item's children (taskIncompleted)
